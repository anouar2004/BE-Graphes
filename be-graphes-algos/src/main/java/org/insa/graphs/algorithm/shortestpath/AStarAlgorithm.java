...
public class AStarAlgorithm extends DijkstraAlgorithm {
    ...
    protected ShortestPathSolution doRun() {
        ...
        for (int i = 0; i < nbNodes; i++) {
            labels[i] = new LabelStar(data.getGraph().get(i), data.getDestination().getPoint().distanceTo(data.getGraph().get(i).getPoint()));
        }
        ...
        // Maintenant que la boucle est terminée, on peut construire la solution à partir des labels
